/**
 * The Server Node Manager Listener is based on the tutorial code provided with the Prosys OPC UA SDK.
 * It handles creating and removing nodes and monitored data items. 
 * As these are not very relevant yet this object must be created the tutorial implementation was used.
 * 
 ...
 */
public class serverNodeManagerListener implements NodeManagerListener {
